...
<body>
	...
	<div id="working_area">
		...
		<div id="form_output_displaying">
			<?php
			$db = new DB();
			$dbQuery = $db->query('article_categories');
			...
			while($object = $dbQuery -> fetch()){
				...
				<div class="form_output_preview form_output_preview_single" title="Pogledajte sadržaj kategorije">
					<a href="article_subcategories.php?id=<?php echo $object['id']; ?>"><p>PREGLED KATEGORIJE</p></a>
				</div>
				<div class="form_output_delete form_output_delete_single" title="Uredite kategoriju">
					<a href="edit_categories.php?id=<?php echo $object['id']; ?>&table=article_categories"><i class="fa fa-edit"></i></a>
				</div>
				<div class="form_output_delete" title="Obrište kategoriju" onclick="deleteObject('article_categories' , '<?php echo $object['id']; ?>');">
		...
		<div class="form_output form_output_add_">
			...
			<div class="form_output_add" title="Spremite kategoriju">
				<input type="submit" value="SPREMITE" onclick="save_product_category('article_categories', 'view_cleaning.php?id=');">
			</div>
		</div>
	</div>
</body>
