	...
	<div id="working_area">
		...
		<div class="textarea_form">
			...
			<div class="textarea_form_input">
				<textarea placeholder="Tekst .." id="details_of_product"></textarea>
			</div>
		</div>
		...
		<div class="insert_image_submit">
			...
			<div class="insert_submit_button insert_submit_button2" title="Spremite unos" onclick="save_product('<?php echo $category_id; ?>');">
				<p>SPREMITE</p>
			</div>
		</div>
	</div>
