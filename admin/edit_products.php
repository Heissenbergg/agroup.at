...
<?php $details = getDetails(Input::get('id')); ?>
...
<body>
	...
	<div id="working_area">
		...
		<div class="insert_image_submit">
			...
			<div class="insert_submit_button insert_submit_button2" title="Spremite unos" onclick="update_product('<?php echo Input::get('id'); ?>');">
				<p>SPREMITE</p>
			</div>
		</div>
	</div>
